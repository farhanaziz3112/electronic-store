import {
  ChevronRightIcon
} from "./chunk-DZDQJJFU.js";
import {
  Tooltip,
  TooltipModule
} from "./chunk-YRXWF6NX.js";
import {
  BaseIcon
...
function Breadcrumb_li_2_a_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("aria-label", ctx_r1.homeAriaLabel)("title", ctx_r1.home.title)("tabindex", ctx_r1.home.disabled ? "-1" : "0")("ariaCurrentWhenActive", ctx_r1.isCurrentUrl(ctx_r1.home));
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r1.home.icon);
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r1.home.icon);
